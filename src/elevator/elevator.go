...
func (e *Elevator) SetPendingHallRequest(floor, hallButton int, active bool) {

	e.m_myBackup.m_pendingHallRequests[floor][hallButton] = active
	e.UpdateMyBackup()
}

func (e *Elevator) GetPendingHallRequest(floor, hallButton int) bool {

	return e.m_myBackup.m_pendingHallRequests[floor][hallButton]
}
